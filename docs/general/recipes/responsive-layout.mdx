...
menu: General
route: /general/recepies/responsive-layout
---
...
<Hint>
  Note that template declaration alone has no effect over responsive area
  rendering. Make sure to supply the template declaration to the respective
  template prop.
</Hint>
...
<Hint>
  You can configure{' '}
  <a href="fundamentals/breakpoints#custom-breakpoints">custom breakpoints</a>,
  default breakpoint and default behavior. Responsive props will abide by your
  settings.
</Hint>
