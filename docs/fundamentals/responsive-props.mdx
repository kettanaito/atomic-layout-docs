...
menu: Fundamentals
route: /fundamentals/responsive-props
---
...
<Hint variant="success">
  Atomic layout is mobile-first. That means that by default responsive props are
  applied starting from the given breakpoint and <strong>up</strong>, unless
  different behavior is specified, or rewriting prop is met.
</Hint>
